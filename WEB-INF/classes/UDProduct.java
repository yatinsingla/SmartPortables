...
public class UDProduct extends HttpServlet implements Serializable {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        beanProduct.setRetailerName(request.getParameter("retailerName"));
		beanProduct.setProductName(request.getParameter("productName"));
		beanProduct.setProductId(Integer.parseInt(request.getParameter("productId")));
		beanProduct.setProductCondition(request.getParameter("productCondition"));
		beanProduct.setProductPrice(Double.parseDouble(request.getParameter("productPrice")));
		beanProduct.setProductAccessories(request.getParameter("productAccessories"));
        beanProduct.setProductCategory(request.getParameter("productCategory"));
        
        arrayList.add(beanProduct);
        hashorder.put("PRODUCTS",arrayList);
        result = database.updateStoremanagerProduct(beanProduct);
	                ...
	                out.println("<section id=\"content\">");
                        ...
                        out.println("<h3></h3>");
                            ...
                            out.println("<table>");
                                ...
                                if(result != 0){
                                    out.println("The Selected product has been Updated ");
                                }else{
                                    out.println("The Selected Product has not been Updated");
                                }

                                out.println("<tr><td><a href='ShowProductStoreManager'>Update another Product</a></td></tr>");
