	                ...
	                out.println("<section id=\"content\">");
                        ...
                        out.println("<h3>Products</h3>");
                            ...
                            out.println("<ul class='products'>");
                                out.println("<li>");
                                    out.println("<a href='#'>");
                                        out.println("<img src='images/smartwatch1.jpg'>");
                                        out.println("<h4>Logo Shirt (Gray)</h4>");
                                        out.println("<p>Price-200$, ID-200, Retailer-DELL, Condition-New</p>");
                                    out.println("</a>");
                                out.println("</li>");
                                out.println("<li>");
                                    out.println("<a href='#'>");
                                        out.println("<img src=\"images/speaker1.jpg\">");
                                        out.println("<h4>Mike the Frog Shirt (Orange)</h4>");
                                        out.println("<p>$25.00</p>");
                                     out.println("</a>");
                                out.println("</li>");
                                out.println("<li>");
                                    out.println("<a href='#'>");
                                        out.println("<img src=\"images/headphone1.jpg\">");
                                        out.println("<h4>Logo Shirt (Gray)</h4>");
                                ...
                                out.println("<li>");
                                    out.println("<a href='#'>");
                                        out.println("<img src=\"images/smartwatch2.jpg\">");
                                        out.println("<h4>Logo Shirt (Gray)</h4>");
                                        out.println("<p>$20.00</p>");
                                     out.println("</a>");
                                out.println("</li>");
                                out.println("<li>");
                                    out.println("<a href='#'>");
                                        out.println("<img src=\"images/speaker2.jpg\">");
                                        out.println("<h4>Mike the Frog Shirt (Orange)</h4>");
                                        out.println("<p>$25.00</p>");
                                     out.println("</a>");
                                out.println("</li>");
                                out.println("<li>");
                                    out.println("<a href='#'>");
                                        out.println("<img src=\"images/smartwatch3.jpg\">");
                                        out.println("<h4>Mike the Frog Shirt (Orange)</h4>");
                                        out.println("<p>$25.00</p>");
                                     out.println("</a>");
                                out.println("</li>");
                    ...
                    out.println("<ul>");	
                        out.println(" <li>");
                            ...
                            if(username!=null){
                                ...
                                out.println("<li><a href=\"login.html\">Trending</a></li>");
                                out.println("<li><a href=\"login.html\">Smart Watches</a></li>");
                                out.println("<li><a href=\"login.html\">Speakers</a></li>");
                                out.println("<li><a href=\"login.html\">Headphones</a></li>");
                                out.println("<li><a href=\"login.html\">Phones</a></li>");
                                out.println("<li><a href=\"login.html\">Laptops</a></li>");
                                out.println("<li><a href=\"login.html\">External Storage</a></li>");
                                out.println("<li><a href=\"login.html\">Accessories</a></li>");
