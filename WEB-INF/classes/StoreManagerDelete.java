...
public class StoreManagerDelete extends HttpServlet implements Serializable {
                            ...
                            out.println("<ul class=\"products\">");
                                ...
                                out.println("<form>");
                                    ...
                                    {	
                                        ...
                                        result = database.deleteProduct(productId);
                                        
                                        if(result != 0)
                                        {
                                            out.println("<tr><td>The Product with product Id "+productId+"has been deleted</td></tr>");
                                        }
                                        else
                                        {
                                            out.println("<tr><td>The Product has not been deleted</td></tr>");
                                        }
                                    }
