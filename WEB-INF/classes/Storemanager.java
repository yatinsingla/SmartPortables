...
public class Storemanager extends HttpServlet implements Serializable {
	                ...
	                out.println("<section id=\"content\">");
                        ...
                        out.println("<h3></h3>");
                            out.println("<ul class=\"products\">");
                                ...
                                out.println("<a href='AddProduct' class='btn btn-info' role='button'>Add Product</a>");
                                out.println("<a href='ShowProductStoreManager' class='btn btn-info' role='button'>Update/Delete Product</a>");
                                out.println("<br>");
                                out.println("<br>");
                                out.println("<a href='DataAnalyticsServlet' class='btn btn-info' role='button'>Data Analytics </a>");
                                out.println("<a href='Inventory' class='btn btn-info' role='button'>Inventory </a>");
                                out.println("<a href='SalesReport' class='btn btn-info' role='button'>Sales Report </a>");
                                out.println("<a href='DataExploration' class='btn btn-info' role='button'>Data Exploration </a>");
