...
public class AddCustomer extends HttpServlet implements Serializable {
                ...
                out.println("<div id=\"body\">");
	                out.println("<section id=\"content\">");
                        ...
                        out.println("<h3></h3>");
                            ...
                            out.println("<form method=\"Get\" action=\"/SinglaYatin/AddCustomerSignup\">");
                                out.println("<h2>ADD CUSTOMER</h2>");
                                out.println("<table>");
                                    out.println("<tr>");
                                        out.println("<td><label>Username</label></td>");
                                        out.println("<td><input type=\"text\" height=\"20\" width=\"30\" name=\"username\" required></td>");
                                    out.println("</tr>");
                                    out.println("<tr>");
                                    ...
                                    out.println("</tr>");
                                    out.println("<tr>");
                                        out.println("<td><label>ReType Password</label></td>");
                                        out.println("<td> <input type=\"password\" name=\"repassword\" required></td>");
                                    out.println("</tr>");
                                    out.println("<tr>");
                                        ...
                                        out.println("</select>");
                                        out.println("<tr>");
                                            out.println("<td> <input type=\"submit\" value=\"Signup\"></td>");
                                        out.println("</tr>");
                                    out.println("</tr>");
                                out.println("</table>");
                            out.println("</form>");
                            ...
                            // out.println("Already have an account? <a href=\"login.html\">Login</a>");	              	
                        out.println("</article>");			 
                    out.println("</section>");
